...
namespace WayLib
{
    public class Type3Finder:WayFinder
    {       
        ...
        private void FindWayType3_(ContainerDictionary dict)
        {
            ...
            if (ContainerPool.Count > 0)
            {
                ...
                var minDistane = ContainerPool.Min(c => c.EndDistance);
                EndMinPool = ContainerPool.Where(c => c.EndDistance == minDistane).ToList();
